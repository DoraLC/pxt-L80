...
namespace gps {
    ...
    //% block="GPS module connected to|TX %tx|RX %rx|Baud rate %speed"
    //% weight=100
    //% speed.defl=BaudRate.BaudRate9600
    //% blockExternalInputs=true
    export function init(tx: SerialPin, rx: SerialPin, speed: BaudRate): void {
        serial.redirect(tx, rx, speed);
    }
